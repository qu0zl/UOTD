...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GameUnitInjury.doctor'
        db.add_column('eotd_gameunitinjury', 'doctor',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'GameUnitInjury.date'
        db.add_column('eotd_gameunitinjury', 'date',
                      self.gf('django.db.models.fields.DateField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GameUnitInjury.doctor'
        db.delete_column('eotd_gameunitinjury', 'doctor')

        # Deleting field 'GameUnitInjury.date'
        db.delete_column('eotd_gameunitinjury', 'date')
