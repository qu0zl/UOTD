...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UnitTemplate.notForPurchase'
        db.add_column('eotd_unittemplate', 'notForPurchase',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding M2M table for field comesWith on 'UnitTemplate'
        db.create_table('eotd_unittemplate_comesWith', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_unittemplate', models.ForeignKey(orm['eotd.unittemplate'], null=False)),
            ('to_unittemplate', models.ForeignKey(orm['eotd.unittemplate'], null=False))
        ))
        db.create_unique('eotd_unittemplate_comesWith', ['from_unittemplate_id', 'to_unittemplate_id'])


    def backwards(self, orm):
        # Deleting field 'UnitTemplate.notForPurchase'
        db.delete_column('eotd_unittemplate', 'notForPurchase')

        # Removing M2M table for field comesWith on 'UnitTemplate'
        db.delete_table('eotd_unittemplate_comesWith')
