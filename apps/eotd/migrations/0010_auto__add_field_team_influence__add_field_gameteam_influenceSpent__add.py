...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Team.influence'
        db.add_column('eotd_team', 'influence',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'GameTeam.influenceSpent'
        db.add_column('eotd_gameteam', 'influenceSpent',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'GameTeam.influenceBought'
        db.add_column('eotd_gameteam', 'influenceBought',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Team.influence'
        db.delete_column('eotd_team', 'influence')

        # Deleting field 'GameTeam.influenceSpent'
        db.delete_column('eotd_gameteam', 'influenceSpent')

        # Deleting field 'GameTeam.influenceBought'
        db.delete_column('eotd_gameteam', 'influenceBought')
