...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UnitTemplate.gent'
        db.add_column('eotd_unittemplate', 'gent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UnitTemplate.gentRetentionCost'
        db.add_column('eotd_unittemplate', 'gentRetentionCost',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UnitTemplate.gent'
        db.delete_column('eotd_unittemplate', 'gent')

        # Deleting field 'UnitTemplate.gentRetentionCost'
        db.delete_column('eotd_unittemplate', 'gentRetentionCost')
