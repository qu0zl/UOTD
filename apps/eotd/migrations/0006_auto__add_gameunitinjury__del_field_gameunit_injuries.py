...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GameUnitInjury'
        db.create_table('eotd_gameunitinjury', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('healed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('injury', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eotd.Injury'])),
            ('gameUnit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eotd.GameUnit'])),
        ))
        db.send_create_signal('eotd', ['GameUnitInjury'])

        # Deleting field 'GameUnit.injuries'
        db.delete_column('eotd_gameunit', 'injuries_id')


    def backwards(self, orm):
        # Deleting model 'GameUnitInjury'
        db.delete_table('eotd_gameunitinjury')

        # Adding field 'GameUnit.injuries'
        db.add_column('eotd_gameunit', 'injuries',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='game_unit_for_injury', null=True, to=orm['eotd.Injury'], blank=True),
                      keep_default=False)
