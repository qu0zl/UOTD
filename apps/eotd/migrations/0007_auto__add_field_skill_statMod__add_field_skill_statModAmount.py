...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Skill.statMod'
        db.add_column('eotd_skill', 'statMod',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Skill.statModAmount'
        db.add_column('eotd_skill', 'statModAmount',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Skill.statMod'
        db.delete_column('eotd_skill', 'statMod')

        # Deleting field 'Skill.statModAmount'
        db.delete_column('eotd_skill', 'statModAmount')
