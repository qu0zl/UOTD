...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UnitTemplate.specialType'
        db.add_column('eotd_unittemplate', 'specialType',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UnitTemplate.specialType'
        db.delete_column('eotd_unittemplate', 'specialType')
